...
<table class="table table-condensed tablesorter" id="table_healthplugwise">
	<thead>
		<tr>
			<th>{{Module}}</th>
			<th>{{ID}}</th>
...
foreach ($eqLogics as $eqLogic) {
  ...
  if ($eqLogic->getConfiguration('type') == 'Stick') echo '<td><span class="label label-info" style="font-size : 1em;">N/A</span></td>';
  else if ($eqLogic->getCmd('info','state')->execCmd() == 1) echo '<td><span class="label label-info" style="font-size : 1em;">On</span></td>';
  else echo '<td><span class="label label-info" style="font-size : 1em;">Off</span></td>';
