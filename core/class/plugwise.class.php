...
class plugwise extends eqLogic
{
  ...
  public static function dependancy_info()
  {
    ...
    $return['progress_file'] = jeedom::getTmpFolder('plugwise') . '/dependance';
  ...
  public static function dependancy_install()
  {
    ...
    return array('script' => dirname(__FILE__) . '/../../resources/nodejs.sh ' . jeedom::getTmpFolder('plugwise') . '/dependance', 'log' => log::getPathToLog(__CLASS__ . '_dep'));
  }
